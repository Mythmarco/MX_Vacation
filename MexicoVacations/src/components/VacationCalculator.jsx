    ...
    return (
        <div className="min-h-screen">
            <div className="max-w-4xl mx-auto relative">
                <div className="grid grid-cols-[1fr_2fr_1fr] items-center mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-left mb-2">
                                    <div className="flex items-center">
                                        <span className="font-bold text-left">Vacation Days Taken:</span>
                                    </div>
                                    <input
                                        type="number"
                                        min="0"
                        ...
                        <div className="space-y-6">
                            <div>
                                <label className="block text-left mb-2">
                                    <div className="flex items-center">
                                        <span className="font-bold text-left">Start Date:</span>
                                    </div>
                                    <input
                                        type="date"
                                        className="border rounded p-2 w-full"
                            ...
                            <div>
                                <label className="block text-left mb-2">
                                    <div className="flex items-center">
                                        <span className="font-bold text-left">Checking Date:</span>
                                    </div>
                                    <input
                                        type="date"
                                        className="border rounded p-2 w-full"
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="section-title mb-0">Output Information</h2>
                        <button 
